...
import static co.gov.sic.encuestas.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import co.gov.sic.encuestas.config.Constants;
import co.gov.sic.encuestas.domain.PersistentToken;
import co.gov.sic.encuestas.domain.User;
import co.gov.sic.encuestas.repository.AuthorityRepository;
import co.gov.sic.encuestas.repository.PersistentTokenRepository;
import co.gov.sic.encuestas.repository.UserRepository;
import co.gov.sic.encuestas.security.AuthoritiesConstants;
import co.gov.sic.encuestas.service.UserService;
import co.gov.sic.encuestas.service.dto.AdminUserDTO;
import co.gov.sic.encuestas.service.dto.PasswordChangeDTO;
import co.gov.sic.encuestas.service.dto.UserDTO;
import co.gov.sic.encuestas.web.rest.vm.KeyAndPasswordVM;
import co.gov.sic.encuestas.web.rest.vm.ManagedUserVM;
